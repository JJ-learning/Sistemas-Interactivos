 ...
 * @author juanjo
 */
public class NewAir extends javax.swing.JFrame {
    ...
    void resetC() throws IOException{
        if(checkFile("src/devices/Air1.txt") == false){
            nameTextField.setText("Air1");
        }else if(checkFile("src/devices/Air2.txt") == false && checkFile("src/devices/Air1.txt") == true){
            nameTextField.setText("Air2");
        }else{
            nameTextField.setText("Air");
        }
    }
    /** Creates new form NewAir */
    public NewAir() {
        try {
            initComponents();
            resetC();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("New air conditioner");
        ...
        AddButton.setText("Create Air Conditioner");
    ...
    private void AddButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddButtonMouseReleased
        try {
            ...
            }else if(temperatureSlider.getValue() == 0){
    ...
    private void temperatureSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_temperatureSliderStateChanged
        // TODO add your handling code here:
        sliderValue.setText(Integer.toString(temperatureSlider.getValue()));
    ...
    void createFile(){
        ...
        // Add state
        try {
            bw.write(Integer.toString(temperatureSlider.getValue()));
        } catch (IOException ex) {
            Logger.getLogger(NewLamp.class.getName()).log(Level.SEVERE, null, ex);
        }
        // New line
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewAir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

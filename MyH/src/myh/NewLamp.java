...
public class NewLamp extends javax.swing.JFrame {
    ...
    void resetC() throws IOException{
        if(checkFile("src/devices/Lamp1.txt") == false){
            nameTextField.setText("Lamp1");
        }else if(checkFile("src/devices/Lamp2.txt") == false && checkFile("src/devices/Lamp1.txt") == true){
            nameTextField.setText("Lamp2");
        }else{
            nameTextField.setText("Lamp");
        }
    }
    /**
     * Creates new form NewLamp
     */
    public NewLamp() {
        try {
            initComponents();
    ...
    private void AddButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddButtonMouseReleased
        try {
            ...
            }else if(colorTextField.getText() == ""){
                colorTextField.setText("Default color");
            }else{
                createFile();
            }
    ...
    void createFile(){
        ...
        // Add state
        try {
            bw.write(colorTextField.getText());
        } catch (IOException ex) {
            Logger.getLogger(NewLamp.class.getName()).log(Level.SEVERE, null, ex);
        }
        // New line

 ...
 * @author juanjo
 */
public class editBlind2 extends javax.swing.JFrame {

    /**
     * Creates new form editBlind2
     */
    public editBlind2() {
        initComponents();
        try {
    ...
    Lock readFile() throws FileNotFoundException, IOException{
        File f = new File("src/devices/Blind2.txt");
    ...
    void changeIp(Lock old, Lock edit) throws IOException{
        java.nio.file.Path path = Paths.get("src/devices/Blind2.txt");
   ...
   void resetComponents() throws IOException{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editBlind2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editBlind2().setVisible(true);
            }
        });
    }

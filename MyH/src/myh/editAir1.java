 ...
 * @author juanjo
 */
public class editAir1 extends javax.swing.JFrame {

    /**
     * Creates new form editAir1
     */
    public editAir1() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Edit Air Conditioner 1");
    ...
    Air readFile() throws FileNotFoundException, IOException{
        File f = new File("src/devices/Air1.txt");
    ...
    void changeIp(Air old, Air edit) throws IOException{
        java.nio.file.Path path = Paths.get("src/devices/Air1.txt");
   ...
   void resetComponents() throws IOException{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editAir1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author juanjo
 */
public class editAir2 extends javax.swing.JFrame {

    /**
     * Creates new form editAir2
     */
    public editAir2() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Edit Air Conditioner 2");
        ...
        SaveButton.setText("Save air conditioner");
    ...
    Air readFile() throws FileNotFoundException, IOException{
        File f = new File("src/devices/Air2.txt");
    ...
    void changeIp(Air old, Air edit) throws IOException{
        java.nio.file.Path path = Paths.get("src/devices/Air2.txt");
    ...
    void editFile(Air old, Air edit){
        try {
            changeIp(old, edit);
        } catch (IOException e) {
            e.printStackTrace();
   ...
   void resetComponents() throws IOException{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editAir2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
